...
class MemoListResource(Resource):
    ...
    def get(self):
        ...
        try:
            ...
            cursor.execute(query, record)
            result_list = cursor.fetchall() # 리스트출력
            print(result_list)
...
class FollowMemoListResource(Resource):
    ...
    def get(self):
        ...
        # print(request.args)  # Query Params 에 있는 값을 가져옴
        # print(request.args.get('offset'))

        ## Query Params는 딕셔너리로 받아오고
        ## 없는 키값을 엑세스해도 에러가 발생하지 않도록 
